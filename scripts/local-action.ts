...
async function main(): Promise<void> {
  ...
  const variables: Array<[string, string]> = [
    ...
    ['SITE_PUBLISHER_NAME', process.env.SITE_PUBLISHER_NAME || process.env.SITE_NAME || 'PulseMesh'],
    ['SITE_AUTHOR_NAME', process.env.SITE_AUTHOR_NAME || process.env.SITE_NAME || 'PulseMesh'],
